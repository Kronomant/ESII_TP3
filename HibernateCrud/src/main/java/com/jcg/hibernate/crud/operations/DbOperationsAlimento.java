...
public class DbOperationsAlimento {
	...
	public static void createRecord(String nome, String preco) {
		...
		try {
			...
			AlimentoObj.setNome(nome);
			AlimentoObj.setPreco(Float.parseFloat(preco));
	...
	public static void updateRecord(int id, String novoNome, String preco) {
		try {
			sessionObj = buildSessionFactory().openSession();
			sessionObj.beginTransaction();
			...
			logger.info(
					"\nAlimento With nome?= " + AlimentoObj.getName() + " Is Successfully Updated In The Database!\n");
		} catch (Exception sqlException) {
			if (null != sessionObj.getTransaction()) {
				logger.info("\n.......Transaction Is Being Rolled Back.......\n");
				sessionObj.getTransaction().rollback();
	...
	public static void deleteRecord(int id) {
		try {
			...
			sessionObj.beginTransaction();
			Alimento704593e706002 AlimentoObj = findRecordById(id);
	...
	public static Alimento704593e706002 findRecordById(int id) {
